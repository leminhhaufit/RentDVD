 ...
 * @author Minh Hau
 */
public class DathanThueGD extends javax.swing.JFrame {
    ...
    public DathanThueGD() {
        ...
        txtHanthue.addKeyListener(new KeyListener() {
			...
			public void keyReleased(KeyEvent e) {
				String giathue = txtHanthue.getText().trim();
		         if(giathue.length()==0){
		...
		btnThoat.addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent e) {
				DathanThueGD.this.setVisible(false);
				
			}
		});
			
		btnDathanThue.addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				if(!(txtHanthue.getText().equalsIgnoreCase(""))) {
					...
					if(vaildData()==true) {
						...
						try {
							...
							if (tddao.updateTieude(td)==true) {
								...
								JOptionPane.showMessageDialog(null, "Đặt hạn thuê thành công!");
							}
						} catch (Exception e) {
							JOptionPane.showMessageDialog(null, e.getMessage());
						}
					}else {
						JOptionPane.showMessageDialog(null, "Đặt hạn thuê không thành công!");
					}
				}else {
		...
		tbTieude.addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent e) {
				int index = tbTieude.getSelectedRow();
				txtHanthue.setText((String) tbTieude.getValueAt(index, 6));
    ...
    private void initComponents() {
        ...
        btnDathanThue = new javax.swing.JButton();
        ...
        btnDathanThue.setIcon(new javax.swing.ImageIcon("D:\\Workspace\\XayDungPM\\XDPMDemo\\icon\\fees.png")); // NOI18N
        btnDathanThue.setText("Đặt hạn thuê");
        btnDathanThue.setToolTipText("");
        btnDathanThue.setPreferredSize(new java.awt.Dimension(220, 100));
                                ...
                                .addGroup(pnChinhLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(pnChinhLayout.createSequentialGroup()
                                        ...
                                        .addGroup(pnChinhLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            ...
                                            .addComponent(txtHanthue, javax.swing.GroupLayout.DEFAULT_SIZE, 262, Short.MAX_VALUE)))
                                    .addGroup(pnChinhLayout.createSequentialGroup()
                                        .addGap(66, 66, 66)
                                        .addComponent(btnThoat, javax.swing.GroupLayout.PREFERRED_SIZE, 220, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(35, 35, 35)
                                        .addComponent(btnDathanThue, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))))
                            .addGroup(pnChinhLayout.createSequentialGroup()
                                .addContainerGap()
        ...
        pnChinhLayout.setVerticalGroup(
            ...
            .addGroup(pnChinhLayout.createSequentialGroup()
                ...
                .addGroup(pnChinhLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(btnDathanThue, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE))
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DathanThueGD().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify                     
    private javax.swing.JButton btnDathanThue;
